...
void Exp::GetMaxSizes(unsigned& params, unsigned& temps,
...
std::ostream& Exp::Write(std::ostream& out, unsigned params, unsigned temps,
                         unsigned signals) const {
...
Exp* Exp::Translate(const std::vector<Slot>& params, unsigned tempStart,
