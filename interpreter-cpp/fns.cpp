...
void One(Param p0) { p0++; }

void Two(Param p0) { p0 += 2; }

void Three(Param p0) { p0 += 3; }
...
void Zero(Param p0) { p0 = 0; }

void Copy(Param p0, Param p1) { p1 += p0; }

void Replace(Param p0, Param p1) { p1 = p0; }
...
void FixedAdd(Param p0, Param p1, Param p2) { p2 += p0 + p1; }
...
void FixMult(Param p0, Param p1, Param p2) { p2 += p0 * p1; }
...
// p0 p1 -> p0 (output), where p0 is an encoded program and p1 is the encoded
// input
...
// p0 p1 1 -> p0 (output) 0/1, depending on whether the program halted or not (0
// == halt)
